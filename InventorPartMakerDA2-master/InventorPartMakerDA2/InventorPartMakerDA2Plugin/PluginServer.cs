...
{
    [Guid("66633c1a-d8cf-4c5c-9a95-3bd6ddead994")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": InventorPartMakerDA2Plugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": InventorPartMakerDA2Plugin: deactivating... ");
